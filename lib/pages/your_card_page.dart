      ...
      body: SingleChildScrollView(
        child: Column(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                    incomeSpending[_currentPageIndex]['income'],
                                    style: GoogleFonts.inter(
                                        textStyle: const TextStyle(
                                            fontSize: 12,
                                            color: textColor,
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => IncomeSpendingPage(pageType: pageType),
            ),
          );
        },
                  ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                margin: const EdgeInsets.only(left: 5),
                                child: Text(
                                    incomeSpending[_currentPageIndex]['spending'],
                                    style: GoogleFonts.inter(
                                        textStyle: const TextStyle(
                                            fontSize: 12,
                                            color: textColor,
          ...
          Navigator.push(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: containerTransaction, borderRadius: BorderRadius.circular(30)),
              child: Column(
                children: [
                  Row(
                    children: [
                        ...
                        Column(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  spending[_currentPageIndex]['nameSpending'],
                                  style: GoogleFonts.inter(
                                      textStyle: const TextStyle(
                                          fontSize: 16,
                                          color: textColor,
                            ...
                            Text(spending[_currentPageIndex]['dateSpending'],
                                style: GoogleFonts.inter(
                                    textStyle: const TextStyle(
                                        fontSize: 12,
                                        color: textColor,
